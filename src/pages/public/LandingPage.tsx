...
const LandingPage = () => {
  ...
  return (
    <div className={`${theme === 'dark' ? 'bg-gray-900 text-white' : 'bg-white text-gray-900'}`}>
      <SEO 
        title="MärchenNails - Premium Nail Salon Services"
        description="Experience premium nail care with our professional team at MärchenNails. Book your appointment today!"
        ogType="website"
      />
      {/* Hero Section */}
                ...
                <div key={service.id} className="flex flex-col overflow-hidden rounded-lg shadow-lg">
                  ...
                  <div className="flex-1 bg-white p-6 flex flex-col justify-between dark:bg-gray-800">
                    ...
                    <div className="mt-4 flex items-center justify-between">
                      ...
                      <Link to="/login" className="text-accent-600 hover:text-accent-800 font-medium dark:text-gray-200">
                        Book Now →
                      </Link>
                    </div>
                  </div>
          ...
          <div className="mt-10">
            <div className="grid grid-cols-1 gap-10 md:grid-cols-3">
              <div className="bg-white p-6 rounded-lg shadow-md dark:bg-gray-800">
                ...
                <h3 className="text-lg font-medium text-gray-900 dark:text-white">Professional & Hygenic</h3>
              ...
              <div className="bg-white p-6 rounded-lg shadow-md dark:bg-gray-800">
                ...
                <h3 className="text-lg font-medium text-gray-900 dark:text-white">Premium Products</h3>
                <p className="mt-2 text-base text-gray-500 dark:text-gray-200">
              ...
              <div className="bg-white p-6 rounded-lg shadow-md dark:bg-gray-800">
                ...
                <h3 className="text-lg font-medium text-gray-900 dark:text-white">Convenient Booking</h3>
                <p className="mt-2 text-base text-gray-500 dark:text-gray-200">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 grid grid-cols-1 gap-10 md:grid-cols-2">
            ...
            <div className="bg-gray-50 rounded-lg overflow-hidden shadow-md p-6 dark:bg-gray-800">
              <h3 className="text-lg font-medium text-gray-900 mb-4 dark:text-white">Our Information</h3>
