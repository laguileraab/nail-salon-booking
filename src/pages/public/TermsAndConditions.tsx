  ...
  const getContent = () => {
    switch (language) {
      case 'de':
        return (
          <>
            <h1 className={`text-3xl font-bold mb-6 ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>Allgemeine Geschäftsbedingungen</h1>
            <div className="space-y-6">
              <section>
                <h2 className={`text-xl font-semibold mb-3 ${theme === 'dark' ? 'text-accent-400' : 'text-accent-600'}`}>1. Geltungsbereich</h2>
                <p>Diese Allgemeinen Geschäftsbedingungen gelten für alle Dienstleistungen und Angebote von MärchenNails.</p>
              </section>
              <section>
                <h2 className={`text-xl font-semibold mb-3 ${theme === 'dark' ? 'text-accent-400' : 'text-accent-600'}`}>2. Terminvereinbarung</h2>
              ...
              <section>
                <h2 className={`text-xl font-semibold mb-3 ${theme === 'dark' ? 'text-accent-400' : 'text-accent-600'}`}>3. Preise und Zahlung</h2>
              ...
              <section>
                <h2 className={`text-xl font-semibold mb-3 ${theme === 'dark' ? 'text-accent-400' : 'text-accent-600'}`}>4. Gesundheitliche Hinweise</h2>
              ...
              <section>
                <h2 className={`text-xl font-semibold mb-3 ${theme === 'dark' ? 'text-accent-400' : 'text-accent-600'}`}>5. Datenschutz</h2>
              ...
              <section>
                <h2 className={`text-xl font-semibold mb-3 ${theme === 'dark' ? 'text-accent-400' : 'text-accent-600'}`}>6. Gerichtsstand und Geltendes Recht</h2>
                <p>Es gilt deutsches Recht. Gerichtsstand ist der Sitz von MärchenNails.</p>
              </section>
              <section>
                <h2 className={`text-xl font-semibold mb-3 ${theme === 'dark' ? 'text-accent-400' : 'text-accent-600'}`}>7. Schlussbestimmungen</h2>
      ...
      case 'es':
        return (
          <>
            <h1 className={`text-3xl font-bold mb-6 ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>Términos y Condiciones</h1>
            <div className="space-y-6">
              <section>
                <h2 className={`text-xl font-semibold mb-3 ${theme === 'dark' ? 'text-accent-400' : 'text-accent-600'}`}>1. Ámbito de Aplicación</h2>
                <p>Estos Términos y Condiciones Generales se aplican a todos los servicios y ofertas de MärchenNails.</p>
              </section>
              <section>
                <h2 className={`text-xl font-semibold mb-3 ${theme === 'dark' ? 'text-accent-400' : 'text-accent-600'}`}>2. Reserva de Citas</h2>
              ...
              <section>
                <h2 className={`text-xl font-semibold mb-3 ${theme === 'dark' ? 'text-accent-400' : 'text-accent-600'}`}>3. Precios y Pagos</h2>
              ...
              <section>
                <h2 className={`text-xl font-semibold mb-3 ${theme === 'dark' ? 'text-accent-400' : 'text-accent-600'}`}>4. Avisos de Salud</h2>
              ...
              <section>
                <h2 className={`text-xl font-semibold mb-3 ${theme === 'dark' ? 'text-accent-400' : 'text-accent-600'}`}>5. Protección de Datos</h2>
              ...
              <section>
                <h2 className={`text-xl font-semibold mb-3 ${theme === 'dark' ? 'text-accent-400' : 'text-accent-600'}`}>6. Jurisdicción y Ley Aplicable</h2>
                <p>Se aplica la ley alemana. La jurisdicción es la sede de MärchenNails.</p>
              </section>
              <section>
                <h2 className={`text-xl font-semibold mb-3 ${theme === 'dark' ? 'text-accent-400' : 'text-accent-600'}`}>7. Disposiciones Finales</h2>
      ...
      default: // English
        return (
          <>
            <h1 className={`text-3xl font-bold mb-6 ${theme === 'dark' ? 'text-white' : 'text-gray-900'}`}>Terms and Conditions</h1>
            <div className="space-y-6">
              <section>
                <h2 className={`text-xl font-semibold mb-3 ${theme === 'dark' ? 'text-accent-400' : 'text-accent-600'}`}>1. Scope</h2>
                <p>These General Terms and Conditions apply to all services and offers from MärchenNails.</p>
              </section>
              <section>
                <h2 className={`text-xl font-semibold mb-3 ${theme === 'dark' ? 'text-accent-400' : 'text-accent-600'}`}>2. Appointment Booking</h2>
              ...
              <section>
                <h2 className={`text-xl font-semibold mb-3 ${theme === 'dark' ? 'text-accent-400' : 'text-accent-600'}`}>3. Prices and Payment</h2>
              ...
              <section>
                <h2 className={`text-xl font-semibold mb-3 ${theme === 'dark' ? 'text-accent-400' : 'text-accent-600'}`}>4. Health Notices</h2>
              ...
              <section>
                <h2 className={`text-xl font-semibold mb-3 ${theme === 'dark' ? 'text-accent-400' : 'text-accent-600'}`}>6. Jurisdiction and Applicable Law</h2>
                <p>German law applies. The place of jurisdiction is the registered office of MärchenNails.</p>
              </section>
              <section>
                <h2 className={`text-xl font-semibold mb-3 ${theme === 'dark' ? 'text-accent-400' : 'text-accent-600'}`}>7. Final Provisions</h2>
  ...
  return (
    <div className={`min-h-screen ${theme === 'dark' ? 'bg-gray-900 text-white' : 'bg-white text-gray-800'}`}>
      <SEO 
        ...
        description={language === 'de' ? 'Die Allgemeinen Geschäftsbedingungen für MärchenNails' : 
                     language === 'es' ? 'Los términos y condiciones para MärchenNails' : 
                     'Terms and conditions for MärchenNails nail salon services'}
        ogType="website"
      />
